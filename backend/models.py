...
class TargetAnalytics(BaseModel):
    ...
    totalScans: int = 0
    countryScans: dict = {}
    engagementTime: float = 0.0 # Total engagement time in seconds
    ctaClicks: int = 0 # Number of clicks on the main CTA button

class ClickRequest(BaseModel):
    """Request schema for logging a CTA click."""
    contentId: str
