...
const ScannerDisplay = ({ post }: ScannerDisplayProps) => {
...
export function convertToEmbedUrl(url: string) {
    ...
    const params = `autoplay=1&mute=0&playsinline=1&rel=0&enablejsapi=1`;
    ...
    try {
        ...
        if (match && match[1]) {
            ...
            // Using youtube-nocookie.com for better privacy/compatibility
